namespace EmailValidatorJson.EmailValidatorJsonCore
{
    ...
    public class PrintEmailList
    {
        ...
        public List<string> RandomEmailSort(List<string> emails)
        {
            if (emails.Count == 0)
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the provided list of email address is null.</exception>
        public List<string> AlphabetEmailSort(List<string> emails)
        {
            if (emails.Count == 0)
                return new List<string>();
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the provided list of email address is null.</exception>
        public List<string> DomainEmailSort(List<string> emails)
        {
            if (emails.Count == 0)
                return new List<string>();
